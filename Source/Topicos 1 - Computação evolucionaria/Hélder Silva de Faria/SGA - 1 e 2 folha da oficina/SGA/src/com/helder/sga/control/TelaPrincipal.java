...
public class TelaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jInternalFrame2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jInternalFrame2Layout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addComponent(labelLugarResposta, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void botaoExecutarTesteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExecutarTesteActionPerformed
        ...
        if (gt.possoTestar) {
            ...
            this.painelResultado.setText(this.painelResultado.getText() + "Não foi possivel fazer testes por falta de uma função");
        }
