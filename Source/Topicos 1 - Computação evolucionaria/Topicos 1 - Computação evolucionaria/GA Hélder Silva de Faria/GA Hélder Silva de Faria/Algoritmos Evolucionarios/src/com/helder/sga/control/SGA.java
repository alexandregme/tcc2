...
public class SGA {
    ...
    /**
     * Classe privada para simbolizar um ponto
     */
    private static class PontoXY {

        private int x;
        private int y;

        /**
         * Cosntrutor para classe PontoXY
         *
         * @param x
         * @param y
         */
    ...
    private void decodificar() {
        ...
        for (int i = 0; i < this.dados.numeroIndividuos; i++) {
            for (int k = 0; k < this.dados.numeroVariaveis * this.dados.nBitsVariavel; k += this.dados.nBitsVariavel) {
                ...
                long l = Long.parseLong(String.valueOf(this.dados.populacao[i]).substring(k, k + this.dados.nBitsVariavel), 2);
     ...
     */
    public void executa(String nomeDir, String nomeArq) {
